...
require 'groupdocs_signature_cloud/models/requests/post_stamp_from_url_request.rb'
...
class Signature_Stamp_From_Url
  def self.Post_Signature_Stamp_From_Url()
    ...
    request = GroupDocsSignatureCloud::PostStampFromUrlRequest.new(url, options, password, $storage_name)
