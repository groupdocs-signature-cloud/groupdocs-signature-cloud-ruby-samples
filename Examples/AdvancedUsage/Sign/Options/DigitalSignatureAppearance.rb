...
class DigitalSignatureAppearance
  def self.Run() 
    ...
    $opts.appearance = GroupDocsSignatureCloud::PdfDigitalSignatureAppearance.new()
    $opts.appearance.appearance_type = "PdfTextSticker"
    $opts.appearance.contact_info_label = "info@groupdocs.cloud"
